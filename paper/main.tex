...
regular level component whose mod-$2$ class is the \emph{horizontal
generator} --- the class of a circle $\{Z=\mathrm{const}\}$, i.e.\ odd
winding in $\xi$ \emph{and} even winding in $Z$. Components of every
other class are allowed: vertical winding, diagonal classes such as the
$(1,1)$-levels of $\cos(\xi-Z)$ (Remark~\ref{rem:sharpness-k}), and
arbitrary behavior at critical values; the conventions are discussed in
